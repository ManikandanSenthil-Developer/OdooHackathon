...
import { PayrollFilterQuery, UpdateSalaryDto } from '../types/payroll.types';

// In-Memory Fallback State (Active if MySQL DB connection is unavailable)
interface FallbackPaystub {
  id: string;
  payroll_id: string;
  employee_id: string;
  month: string;
...
interface FallbackPayroll {
  ...
  created_at: Date;
  updated_at: Date;
  paystubs: FallbackPaystub[];
}

const memoryPayrolls = new Map<string, FallbackPayroll>([
  [
    'EMP-001',
    {
      id: 'pay-001',
      ...
      updated_at: new Date(),
      paystubs: [
        { id: 'ps-101', payroll_id: 'pay-001', employee_id: 'EMP-001', month: 'August 2026', amount: 62500, status: 'Paid', disbursed_at: new Date() },
        { id: 'ps-102', payroll_id: 'pay-001', employee_id: 'EMP-001', month: 'July 2026', amount: 62500, status: 'Paid', disbursed_at: new Date(Date.now() - 30 * 86400000) },
        { id: 'ps-103', payroll_id: 'pay-001', employee_id: 'EMP-001', month: 'June 2026', amount: 62500, status: 'Paid', disbursed_at: new Date(Date.now() - 60 * 86400000) },
      ],
    },
  ],
  [
    'EMP-002',
    {
      ...
      updated_at: new Date(),
      paystubs: [
        { id: 'ps-201', payroll_id: 'pay-002', employee_id: 'EMP-002', month: 'August 2026', amount: 74000, status: 'Paid', disbursed_at: new Date() },
        { id: 'ps-202', payroll_id: 'pay-002', employee_id: 'EMP-002', month: 'July 2026', amount: 74000, status: 'Paid', disbursed_at: new Date(Date.now() - 30 * 86400000) },
      ],
    },
  ],
]);
